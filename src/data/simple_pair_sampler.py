...
__all__ = ["PairSimpleTrainingSampler", "PairSimpleDataLoader"]


class PairSimpleTrainingSampler(Sampler):
    """
    Similar to TrainingSampler, but produces a pair of training images from the
    same video sequence. We abandon the window size conecpt and randomly sample closest frames.
    """
